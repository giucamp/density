...
namespace density
{
    namespace tests
    {
        ...
        /* Returns the hash of a TestObjectBase. This function is compliant with hash */
        ...
        /** Returns the hash of an AlignedRandomStorage. This function is compliant with hash */
        template <size_t SIZE, size_t ALIGNMENT>
        ...
        /** Returns the hash of an ComplexTypeBase. This function is compliant with hash */
