...
namespace density
{
    namespace tests
    {
        ...
        void add_function_queue_benchmarks(TestTree & i_tree)
        {
            i_tree.add_performance_test(make_function_queue_benchmarks_nocapture());
            i_tree.add_performance_test(make_function_queue_benchmarks_midcapture());
            i_tree.add_performance_test(make_function_queue_benchmarks_bigcapture());
        }
