...
{
	void nonblocking_heterogeneous_queue_lifetime_tests()
	{
	...
	template <typename QUEUE>
		void nonblocking_heterogeneous_queue_basic_void_tests()
	{
	...
	void nonblocking_heterogeneous_queue_basic_nonpolymorphic_base_tests()
	{
		using namespace density;
	...
	void nonblocking_heterogeneous_queue_basic_polymorphic_base_tests()
	{
		using namespace density;
		using namespace type_features;
