		...
		*/
		...
		public:
			...
			template <page_allocation_type ALLOCATION_TYPE>
				static void * try_allocate_page(progress_guarantee const i_progress_guarantee)
			{
				PageFooter * const new_page = t_thread_entry.try_allocate_page<ALLOCATION_TYPE>(i_progress_guarantee);
				...
				static void deallocate_page(void * const i_page) noexcept
			{
				...
				t_thread_entry.deallocate_page<ALLOCATION_TYPE>(footer);
			}
