...
namespace density
{
    ...
    */
    ...
    public:
        ...
        heter_queue(const ALLOCATOR_TYPE & i_source_allocator)
        ...
        heter_queue(ALLOCATOR_TYPE && i_source_allocator) noexcept
        ...
        public:
            ...
            heter_queue * queue() const noexcept { return m_control != nullptr ? m_queue : nullptr; }
