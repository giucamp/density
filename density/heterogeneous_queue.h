...
namespace density
{
    ...
    private:
        ...
        DENSITY_NO_INLINE void make_space(size_t i_required_size, size_t i_required_alignment)
        {
            ...
            if (min_page_size <= VOID_ALLOCATOR::page_size)
            {
                actual_page_size = VOID_ALLOCATOR::page_size;
        ...
        void delete_page(PageHeader * i_page) noexcept
        {
            ...
            DENSITY_ASSERT(actual_page_size >= VOID_ALLOCATOR::page_size);
            if (actual_page_size <= VOID_ALLOCATOR::page_size)
            {
