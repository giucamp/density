...
{
    template <typename QUEUE> class QueueGenericTester
    {
      public:
        using PutTestCase     = bool (*)(QUEUE & i_queue, EasyRandom &);
        using ConsumeTestCase = void (*)(const typename QUEUE::consume_operation & i_queue);

        using ReentrantPutTestCase = typename QUEUE::template reentrant_put_transaction<void> (*)(
          QUEUE & i_queue, EasyRandom &);
        using ReentrantConsumeTestCase =
          void (*)(const typename QUEUE::reentrant_consume_operation & i_queue);
        ...
        template <typename PUT_CASE> void add_test_case()
        {
      ...
      private:
        ...
        struct PutTypeCounters
        {
            ...
            int64_t m_existing{
              0}; /**< How many elements of this type currently exist in the queue. */
        ...
        struct FinalStats
        {
            ...
            FinalStats(size_t i_put_type_count) : m_counters(i_put_type_count) {}
        ...
        class alignas(density::destructive_interference_size) ThreadData
        {
          public:
            ...
            const IncrementalStats & incremental_stats() const { return *m_incremental_stats; }
          ...
          private: // internal data
            ...
            struct ReentrantPut
            {
                ...
                ReentrantPut(
                  size_t                                                      i_type_index,
                  typename QUEUE::template reentrant_put_transaction<void> && i_transaction)
            ...
            struct ReentrantConsume
            {
                ...
                ReentrantConsume(
                  size_t i_type_index, typename QUEUE::reentrant_consume_operation && i_operation)
