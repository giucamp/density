...
namespace density_tests
{
    ...
    void resume_thread(std::thread & i_thread) { ResumeThread(i_thread.native_handle()); }
...
#pragma warning(pop)
    ...
    bool set_thread_priority(std::thread & i_thread, thread_priority i_priority) { return false; }

    bool supend_thread(std::thread &) { return false; }

    void resume_thread(std::thread &) {}

    bool set_thread_name(std::thread &, const char *) { return false; }

#else

    uint64_t get_num_of_processors() { return 0; }

    bool set_thread_affinity(uint64_t) { return false; }

    bool set_thread_affinity(std::thread &, uint64_t) { return false; }
    ...
    bool set_thread_priority(thread_priority i_priority) { return false; }
