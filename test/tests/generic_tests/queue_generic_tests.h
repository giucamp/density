...
namespace density_tests
{
    ...
    namespace detail
    {
        template <typename QUEUE> struct PutInt
        {
        ...
        template <typename QUEUE> struct PutString
        {
        ...
        template <typename QUEUE> struct PutUInt8
        {
        ...
        template <typename QUEUE> struct PutUInt16
        {
        ...
        template <typename QUEUE> struct TryPutFloat
        {
        ...
        template <typename QUEUE, size_t SIZE, size_t ALIGNMENT> struct PutTestObject
        {
        ...
        template <typename QUEUE> struct PutRawBlocks
        {
        ...
        template <typename QUEUE> struct ReentrantPush
        {
        ...
        template <typename QUEUE>
        void single_lf_queue_generic_test(
          QueueTesterFlags    i_flags,
          std::ostream &      i_output,
          EasyRandom &        i_random,
          size_t              i_element_count,
        ...
        template <
          density::concurrency_cardinality PROD_CARDINALITY     = density::concurrency_multiple,
