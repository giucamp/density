...
namespace density_tests
{
    ...
    function_queue<int (std::vector<std::string> & vect), default_allocator, ERASURE> queue;
    ...
    using Queue = function_queue<int (std::vector<std::string> & vect), default_allocator, ERASURE>;
    Queue queue;
