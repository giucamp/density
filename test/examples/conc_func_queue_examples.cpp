...
namespace density_tests
{
    ...
    conc_function_queue<int (std::vector<std::string> & vect), default_allocator, ERASURE> queue;
    ...
    using Queue = conc_function_queue<int (std::vector<std::string> & vect), default_allocator, ERASURE>;
    Queue queue;
