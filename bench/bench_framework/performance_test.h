...
namespace density_bench
{
    ...
    class PerformanceTestGroup
    {
      public:
        ...
        void set_prolog_code(std::string i_code) { m_prolog_code = std::move(i_code); }
        ...
        void add_test(PerformanceTest i_test) { m_tests.push_back(std::move(i_test)); }
        ...
        void set_cardinality_start(size_t i_cardinality_start)
        {
            m_cardinality_start = i_cardinality_start;
        }
        void set_cardinality_step(size_t i_cardinality_step)
        {
            m_cardinality_step = i_cardinality_step;
        }
        void set_cardinality_end(size_t i_cardinality_end)
        {
            m_cardinality_end = i_cardinality_end;
        }
        ...
        static const char * set_source_dir() { return s_source_dir.c_str(); }
