    ...
    */
            ...
            detail::LFQueue_Tail<RUNTIME_TYPE, ALLOCATOR_TYPE, PROD_CARDINALITY, CONSISTENCY_MODEL>>
    {
      ...
      public:
        ...
        \snippet lf_queue_examples.cpp lf_heter_queue default_construct example 1 */
        ...
        /** Constructor with allocator parameter. The allocator is copy-constructed.
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue construct_copy_alloc example 1 */
        ...
        \snippet lf_queue_examples.cpp lf_heter_queue construct_move_alloc example 1 */
        ...
        \snippet lf_queue_examples.cpp lf_heter_queue move_construct example 1 */
        ...
        \snippet lf_queue_examples.cpp lf_heter_queue move_assign example 1 */
        ...
        /** Returns a copy of the allocator
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue get_allocator example 1 */
        allocator_type get_allocator() noexcept { return *this; }

        /** Returns a reference to the allocator

            \snippet lf_queue_examples.cpp lf_heter_queue get_allocator_ref example 1 */
        allocator_type & get_allocator_ref() noexcept { return *this; }

        /** Returns a const reference to the allocator

        \snippet lf_queue_examples.cpp lf_heter_queue get_allocator_ref example 2 */
        const allocator_type & get_allocator_ref() const noexcept { return *this; }

        /** Swaps two queues.

        \snippet lf_queue_examples.cpp lf_heter_queue swap example 1 */
        ...
        \snippet lf_queue_examples.cpp lf_heter_queue empty example 1 */
        ...
        \snippet lf_queue_examples.cpp lf_heter_queue clear example 1 */
        void clear() noexcept
        {
        ...
        template <typename ELEMENT_COMPLETE_TYPE = void> class put_transaction
        {
          ...
          public:
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction copy_construct example 1 */
            put_transaction(const put_transaction &) = delete;

            /** Copy assignment is not allowed.

            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction copy_assign example 1 */
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction move_construct example 1

            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction move_construct example 2 */
            template <
              typename OTHERTYPE,
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction move_assign example 1
            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction move_assign example 2 */
            template <
              typename OTHERTYPE,
              typename = typename std::enable_if<
                std::is_same<OTHERTYPE, ELEMENT_COMPLETE_TYPE>::value ||
            ...
            /** Swaps two instances of put_transaction.
                ...
                \snippet lf_queue_examples.cpp lf_heter_queue put_transaction swap example 1 */
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction raw_allocate example 1*/
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction raw_allocate_copy example 1*/
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction raw_allocate_copy example 2 */
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction try_raw_allocate example 1*/
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction try_raw_allocate_copy example 1*/
            template <typename INPUT_ITERATOR>
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction try_raw_allocate_copy example 2 */
            template <typename INPUT_RANGE>
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction cancel example 1 */
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction empty example 1 */
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction operator_bool example 1 */
            ...
            /** Returns a pointer to the target queue if a transaction is bound, otherwise returns nullptr
                ...
                \snippet lf_queue_examples.cpp lf_heter_queue put_transaction queue example 1 */
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction element_ptr example 1

            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction element_ptr example 2 */
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue typed_put_transaction element example 1 */
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue put_transaction complete_type example 1 */
            ...
            /** If this transaction is empty the destructor has no side effects. Otherwise it cancels it.
                ...
                \snippet lf_queue_examples.cpp lf_heter_queue put_transaction destroy example 1 */
            ~put_transaction()
            {
        ...
        class consume_operation
        {
          public:
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue consume_operation default_construct example 1 */
            consume_operation() noexcept = default;

            /** Copy construction is not allowed

            \snippet lf_queue_examples.cpp lf_heter_queue consume_operation copy_construct example 1 */
            consume_operation(const consume_operation &) = delete;

            /** Copy assignment is not allowed

            \snippet lf_queue_examples.cpp lf_heter_queue consume_operation copy_assign example 1 */
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue consume_operation move_construct example 1 */
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue consume_operation move_assign example 1 */
            consume_operation & operator=(consume_operation && i_source) noexcept = default;

            /** Destructor: cancel the operation (if any).

            \snippet lf_queue_examples.cpp lf_heter_queue consume_operation destroy example 1 */
            ~consume_operation()
            {
            ...
            /** Swaps two instances of consume_operation.
                ...
                \snippet lf_queue_examples.cpp lf_heter_queue consume_operation swap example 1 */
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue consume_operation empty example 1 */
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue consume_operation operator_bool example 1 */
            explicit operator bool() const noexcept { return !m_consume_data.empty(); }

            /** Returns a pointer to the target queue if a transaction is bound, otherwise returns nullptr

                \snippet lf_queue_examples.cpp lf_heter_queue consume_operation queue example 1 */
            lf_heter_queue * queue() const noexcept
            {
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue consume_operation commit_nodestroy example 1 */
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue consume_operation cancel example 1 */
            void cancel() noexcept
            {
                DENSITY_ASSERT(!empty());
                m_consume_data.cancel_consume_impl();
            ...
            /** Returns the type of the element being consumed.
                ...
                \snippet lf_queue_examples.cpp lf_heter_queue consume_operation complete_type example 1 */
            const RUNTIME_TYPE & complete_type() const noexcept
            {
                DENSITY_ASSERT(!empty());
            ...
            /** Returns a pointer that, if properly aligned to the alignment of the element type, points to the element.
                ...
                \snippet lf_queue_examples.cpp lf_heter_queue consume_operation unaligned_element_ptr example 1 */
            ...
            /** Returns a pointer to the element being consumed.
                ...
                \snippet lf_queue_examples.cpp lf_heter_queue consume_operation element_ptr example 1 */
            void * element_ptr() const noexcept
            {
                DENSITY_ASSERT(!empty());
            ...
            /** Returns a reference to the element being consumed.
                ...
                \snippet lf_queue_examples.cpp lf_heter_queue consume_operation element example 1 */
        ...
        /** Appends at the end of the queue an element of type <code>ELEMENT_TYPE</code>, copy-constructing or move-constructing
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue push example 1 */
        ...
        /** Appends at the end of the queue an element of type <code>ELEMENT_TYPE</code>, in-place-constructing it from
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue emplace example 1 */
        ...
        /** Adds at the end of the queue an element of a type known at runtime, default-constructing it.
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue dyn_push example 1 */
        ...
        /** Appends at the end of the queue an element of a type known at runtime, copy-constructing it from the source.
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue dyn_push_copy example 1 */
        ...
        /** Adds at the end of the queue an element of a type known at runtime, move-constructing it from the source.
            ...
            @param i_type type of the new element
            @param i_source pointer to the object to use as source. If this pointer does dot point to an object whose
                dynamic type is the the target type i_type was bound to, the behavior is undefined.
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue dyn_push_move example 1 */
        ...
        /** Begins a transaction that appends an element of type <code>ELEMENT_TYPE</code>, copy-constructing
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue start_push example 1 */
        ...
        /** Begins a transaction that appends an element of a type <code>ELEMENT_TYPE</code>,
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue start_emplace example 1 */
        template <typename ELEMENT_TYPE, typename... CONSTRUCTION_PARAMS>
        ...
        /** Begins a transaction that appends an element of a type known at runtime, default-constructing it.
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue start_dyn_push example 1 */
        ...
        /** Begins a transaction that appends an element of a type known at runtime, copy-constructing it from the source..
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue start_dyn_push_copy example 1 */
        ...
        /** Begins a transaction that appends an element of a type known at runtime, move-constructing it from the source..
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue start_dyn_push_move example 1 */
        ...
        /** Tries to append at the end of the queue an element of type <code>ELEMENT_TYPE</code>, copy-constructing or move-constructing
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_push example 1 */
        template <typename ELEMENT_TYPE>
        ...
        /** Tries to append at the end of the queue an element of type <code>ELEMENT_TYPE</code>, in-place-constructing it from
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_emplace example 1 */
        template <typename ELEMENT_TYPE, typename... CONSTRUCTION_PARAMS>
        bool
        ...
        /** Tries to add at the end of the queue an element of a type known at runtime, default-constructing it.
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_dyn_push example 1 */
        ...
        /** Tries to add at the end of the queue an element of a type known at runtime, copy-constructing it from the source.
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_dyn_push_copy example 1 */
        ...
        /** Tries add at the end of the queue an element of a type known at runtime, move-constructing it from the source.
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_dyn_push_move example 1 */
        ...
        /** Tries to begin a transaction that appends an element of type <code>ELEMENT_TYPE</code>, copy-constructing or move-constructing it
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_start_push example 1 */
        template <typename ELEMENT_TYPE>
        ...
        /** Tries to begin a transaction that appends an element of a type <code>ELEMENT_TYPE</code>,
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_start_emplace example 1 */
        template <typename ELEMENT_TYPE, typename... CONSTRUCTION_PARAMS>
        ...
        /** Tries to begin a transaction that appends an element of a type known at runtime, default-constructing it.
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_start_dyn_push example 1 */
        put_transaction<>
        ...
        /** Tries to begin a transaction that appends an element of a type known at runtime, copy-constructing it from the source.
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_start_dyn_push_copy example 1 */
        ...
        /** Tries to begin a transaction that appends an element of a type known at runtime, move-constructing it from the source.
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_start_dyn_push_move example 1 */
        ...
        /** Removes and destroy the first element of the queue, if the queue is not empty. Otherwise it has no effect.
            ...
            \n <b>Throws</b>: nothing
        \snippet lf_queue_examples.cpp lf_heter_queue try_pop example 1 */
        ...
        /** Tries to start a consume operation.
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue try_start_consume example 1 */
        ...
        /** Tries to start a consume operation using an existing consume_operation object.
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue try_start_consume_ example 1 */
        ...
        template <typename ELEMENT_COMPLETE_TYPE = void> class reentrant_put_transaction
        {
          ...
          public:
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction copy_construct example 1 */
            reentrant_put_transaction(const reentrant_put_transaction &) = delete;

            /** Copy assignment is not allowed.

            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction copy_assign example 1 */
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction move_construct example 1

            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction move_construct example 2 */
            template <
              typename OTHERTYPE,
              typename = typename std::enable_if<
                std::is_same<OTHERTYPE, ELEMENT_COMPLETE_TYPE>::value ||
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction move_assign example 1
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction move_assign example 2 */
            template <
              typename OTHERTYPE,
              typename = typename std::enable_if<
                std::is_same<OTHERTYPE, ELEMENT_COMPLETE_TYPE>::value ||
            ...
            /** Swaps two instances of reentrant_put_transaction.
                ...
                \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction swap example 1 */
            friend void swap(
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction raw_allocate example 1*/
            void * raw_allocate(size_t i_size, size_t i_alignment)
            {
                DENSITY_ASSERT(!empty());
                auto push_data =
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction raw_allocate_copy example 1*/
            template <typename INPUT_ITERATOR>
            typename std::iterator_traits<INPUT_ITERATOR>::value_type *
              raw_allocate_copy(INPUT_ITERATOR i_begin, INPUT_ITERATOR i_end)
            {
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction raw_allocate_copy example 2 */
            template <typename INPUT_RANGE>
            auto raw_allocate_copy(const INPUT_RANGE & i_source_range)
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction try_raw_allocate example 1*/
            void * try_raw_allocate(
              progress_guarantee i_progress_guarantee, size_t i_size, size_t i_alignment) noexcept
            {
                DENSITY_ASSERT(!empty());
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction try_raw_allocate_copy example 1*/
            template <typename INPUT_ITERATOR>
            typename std::iterator_traits<INPUT_ITERATOR>::value_type * try_raw_allocate_copy(
              progress_guarantee i_progress_guarantee,
              INPUT_ITERATOR     i_begin,
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction try_raw_allocate_copy example 2 */
            template <typename INPUT_RANGE>
            auto try_raw_allocate_copy(
              progress_guarantee i_progress_guarantee,
              const INPUT_RANGE &
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction cancel example 1 */
            void cancel() noexcept
            {
                DENSITY_ASSERT(!empty());
                Base::cancel_put_impl(m_put);
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction empty example 1 */
            bool empty() const noexcept { return m_put.m_user_storage == nullptr; }

            /** Returns true whether this object is bound to a transaction. Same to !consume_operation::empty.

            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction operator_bool example 1 */
            explicit operator bool() const noexcept { return m_put.m_user_storage != nullptr; }

            /** Returns a pointer to the target queue if a transaction is bound, otherwise returns nullptr

                \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction queue example 1 */
            lf_heter_queue * queue() const noexcept
            {
                return m_put.m_user_storage != nullptr ? m_queue : nullptr;
            }
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction element_ptr example 1

            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction element_ptr example 2 */
            void * element_ptr() const noexcept
            {
                DENSITY_ASSERT(!empty());
                return m_put.m_user_storage;
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction complete_type example 1 */
            const RUNTIME_TYPE & complete_type() const noexcept
            {
                DENSITY_ASSERT(!empty());
                return *Base::type_after_control(m_put.m_control_block);
            ...
            /** If this transaction is empty the destructor has no side effects. Otherwise it cancels it.
                ...
                \snippet lf_queue_examples.cpp lf_heter_queue reentrant_put_transaction destroy example 1 */
            ~reentrant_put_transaction()
            {
                if (m_put.m_user_storage != nullptr)
                {
        ...
        class reentrant_consume_operation
        {
          public:
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_consume_operation default_construct example 1 */
            reentrant_consume_operation() noexcept = default;

            /** Copy construction is not allowed

            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_consume_operation copy_construct example 1 */
            reentrant_consume_operation(const reentrant_consume_operation &) = delete;

            /** Copy assignment is not allowed

            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_consume_operation copy_assign example 1 */
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_consume_operation move_construct example 1 */
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_consume_operation move_assign example 1 */
            reentrant_consume_operation &
              operator=(reentrant_consume_operation && i_source) noexcept = default;

            /** Destructor: cancel the operation (if any).

            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_consume_operation destroy example 1 */
            ~reentrant_consume_operation()
            {
                if (!m_consume_data.empty())
                {
            ...
            /** Swaps two instances of reentrant_consume_operation.
                ...
                \snippet lf_queue_examples.cpp lf_heter_queue reentrant_consume_operation swap example 1 */
            friend void swap(
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_consume_operation empty example 1 */
            bool empty() const noexcept { return m_consume_data.empty(); }

            /** Returns true whether this object does not hold the state of an operation. Same to !reentrant_consume_operation::empty.

            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_consume_operation operator_bool example 1 */
            explicit operator bool() const noexcept { return !m_consume_data.empty(); }

            /** Returns a pointer to the target queue if a transaction is bound, otherwise returns nullptr

                \snippet lf_queue_examples.cpp lf_heter_queue reentrant_consume_operation queue example 1 */
            lf_heter_queue * queue() const noexcept
            {
                return static_cast<lf_heter_queue *>(m_consume_data.m_queue);
            }
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_consume_operation commit_nodestroy example 1 */
            void commit_nodestroy() noexcept
            {
                DENSITY_ASSERT(!empty());
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_consume_operation cancel example 1 */
            void cancel() noexcept
            {
                DENSITY_ASSERT(!empty());
                m_consume_data.cancel_consume_impl();
            ...
            /** Returns the type of the element being consumed.
                ...
                \snippet lf_queue_examples.cpp lf_heter_queue reentrant_consume_operation complete_type example 1 */
            const RUNTIME_TYPE & complete_type() const noexcept
            {
                DENSITY_ASSERT(!empty());
                return *Base::type_after_control(m_consume_data.m_control);
            ...
            /** Returns a pointer that, if properly aligned to the alignment of the element type, points to the element.
                ...
                \snippet lf_queue_examples.cpp lf_heter_queue reentrant_consume_operation unaligned_element_ptr example 1 */
            void * unaligned_element_ptr() const noexcept
            {
                DENSITY_ASSERT(!empty());
                return Base::get_unaligned_element(
            ...
            /** Returns a pointer to the element being consumed.
                ...
                \snippet lf_queue_examples.cpp lf_heter_queue reentrant_consume_operation element_ptr example 1 */
            void * element_ptr() const noexcept
            {
                DENSITY_ASSERT(!empty());
                return Base::get_element(m_consume_data.m_control, m_consume_data.external());
            ...
            /** Returns a reference to the element being consumed.
                ...
                \snippet lf_queue_examples.cpp lf_heter_queue reentrant_consume_operation element example 1 */
            template <typename COMPLETE_ELEMENT_TYPE>
            COMPLETE_ELEMENT_TYPE & element() const noexcept
            {
                DENSITY_ASSERT(!empty() && complete_type().template is<COMPLETE_ELEMENT_TYPE>());
        ...
        /** Same to lf_heter_queue::push, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_push example 1 */
        ...
        /** Same to lf_heter_queue::emplace, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_emplace example 1 */
        template <typename ELEMENT_TYPE, typename... CONSTRUCTION_PARAMS>
        ...
        /** Same to lf_heter_queue::dyn_push, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_dyn_push example 1 */
        ...
        /** Same to lf_heter_queue::dyn_push_copy, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_dyn_push_copy example 1 */
        ...
        /** Same to lf_heter_queue::dyn_push_move, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue reentrant_dyn_push_move example 1 */
        ...
        /** Same to lf_heter_queue::start_push, but allows reentrancy: during the construction of the element, and until the state of
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue start_reentrant_push example 1 */
        template <typename ELEMENT_TYPE>
        ...
        /** Same to lf_heter_queue::start_emplace, but allows reentrancy: during the construction of the element, and until the state of
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue start_reentrant_emplace example 1 */
        template <typename ELEMENT_TYPE, typename... CONSTRUCTION_PARAMS>
        ...
        /** Same to lf_heter_queue::start_dyn_push, but allows reentrancy: during the construction of the element, and until the state of
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue start_reentrant_dyn_push example 1 */
        ...
        /** Same to lf_heter_queue::start_dyn_push_copy, but allows reentrancy: during the construction of the element, and until the state of
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue start_reentrant_dyn_push_copy example 1 */
        reentrant_put_transaction<>
        ...
        /** Same to lf_heter_queue::start_dyn_push_move, but allows reentrancy: during the construction of the element, and until the state of
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue start_reentrant_dyn_push_move example 1 */
        reentrant_put_transaction<>
        ...
        /** Same to lf_heter_queue::try_push, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_reentrant_push example 1 */
        template <typename ELEMENT_TYPE>
        ...
        /** Same to lf_heter_queue::try_emplace, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_start_reentrant_emplace example 1 */
        template <typename ELEMENT_TYPE, typename... CONSTRUCTION_PARAMS>
        bool
        ...
        /** Same to lf_heter_queue::try_dyn_push, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_reentrant_dyn_push example 1 */
        ...
        /** Same to lf_heter_queue::try_dyn_push_copy, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_reentrant_dyn_push_copy example 1 */
        ...
        /** Same to lf_heter_queue::try_dyn_push_move, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_reentrant_dyn_push_move example 1 */
        ...
        /** Same to lf_heter_queue::try_start_push, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_start_reentrant_push example 1 */
        template <typename ELEMENT_TYPE>
        ...
        /** Same to lf_heter_queue::try_start_dyn_push, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_start_reentrant_dyn_push example 1 */
        ...
        /** Same to lf_heter_queue::try_start_dyn_push_copy, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_start_reentrant_dyn_push_copy example 1 */
        ...
        /** Same to lf_heter_queue::try_start_dyn_push_move, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet lf_queue_examples.cpp lf_heter_queue try_start_reentrant_dyn_push_move example 1 */
        ...
        /** Removes and destroy the first element of the queue, if the queue is not empty. Otherwise it has no effect.
            ...
            \n <b>Effects on iterators</b>: any iterator pointing to the first element is invalidated
            \n <b>Throws</b>: nothing
        \snippet lf_queue_examples.cpp lf_heter_queue try_reentrant_pop example 1 */
        ...
        /** Tries to start a reentrant consume operation.
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue try_start_reentrant_consume example 1 */
        ...
        /** Tries to start a consume operation using an existing consume_operation object.
            ...
            \snippet lf_queue_examples.cpp lf_heter_queue try_start_reentrant_consume_ example 1 */
