...
namespace density
{
    /** Class template implementing a concurrent heterogeneous FIFO pseudo-container.
        ...
        canceled or committed). Reentrant operations minimize the durations of the locks: the mutex is locked once when
    ...
    class conc_heter_queue
    {
      ...
      public:
        ...
        \snippet conc_queue_examples.cpp conc_heter_queue default_construct example 1 */
        ...
        /** Constructor with allocator parameter. The allocator is copy-constructed.
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue construct_copy_alloc example 1 */
        constexpr explicit conc_heter_queue(const ALLOCATOR_TYPE & i_source_allocator) noexcept
        ...
        \snippet conc_queue_examples.cpp conc_heter_queue construct_move_alloc example 1 */
        constexpr explicit conc_heter_queue(ALLOCATOR_TYPE && i_source_allocator) noexcept
        ...
        \snippet conc_queue_examples.cpp conc_heter_queue move_construct example 1 */
        ...
        \snippet conc_queue_examples.cpp conc_heter_queue move_assign example 1 */
        ...
        /** Returns a copy of the allocator
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue get_allocator example 1 */
        allocator_type
        ...
        /** Returns a reference to the allocator
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue get_allocator_ref example 1 */
        allocator_type & get_allocator_ref() noexcept { return m_queue.get_allocator_ref(); }

        /** Returns a const reference to the allocator

        \snippet conc_queue_examples.cpp conc_heter_queue get_allocator_ref example 2 */
        ...
        \snippet conc_queue_examples.cpp conc_heter_queue swap example 1 */
        friend void swap(
        ...
        \snippet conc_queue_examples.cpp conc_heter_queue empty example 1 */
        ...
        \snippet conc_queue_examples.cpp conc_heter_queue clear example 1 */
        void clear() noexcept
        {
            std::lock_guard<std::mutex> lock(m_mutex);
            m_queue.clear();
        ...
        /** Move-only class template that can be bound to a put transaction, otherwise it's empty.
            ...
            Transactional put functions on conc_heter_queue return a non-empty put_transaction that can be
        ...
        template <typename ELEMENT_COMPLETE_TYPE = void> class put_transaction
        {
          ...
          public:
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue put_transaction copy_construct example 1 */
            put_transaction(const put_transaction &) = delete;

            /** Copy assignment is not allowed.

            \snippet conc_queue_examples.cpp conc_heter_queue put_transaction copy_assign example 1 */
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue put_transaction move_construct example 1

            \snippet conc_queue_examples.cpp conc_heter_queue put_transaction move_construct example 2 */
            template <
              typename OTHERTYPE,
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue put_transaction move_assign example 1
            \snippet conc_queue_examples.cpp conc_heter_queue put_transaction move_assign example 2 */
            template <
              typename OTHERTYPE,
              typename = typename std::enable_if<
                std::is_same<OTHERTYPE, ELEMENT_COMPLETE_TYPE>::value ||
            ...
            /** Swaps two instances of put_transaction.
                ...
                \snippet conc_queue_examples.cpp conc_heter_queue put_transaction swap example 1 */
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue put_transaction raw_allocate example 1*/
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue put_transaction raw_allocate_copy example 1*/
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue put_transaction raw_allocate_copy example 2 */
            ...
            {
                return m_put_transaction.raw_allocate_copy(
                  std::begin(i_source_range), std::end(i_source_range));
            }
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue put_transaction cancel example 1 */
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue put_transaction empty example 1 */
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue put_transaction operator_bool example 1 */
            explicit operator bool() const noexcept { return m_put_transaction.operator bool(); }
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue put_transaction element_ptr example 1

            \snippet conc_queue_examples.cpp conc_heter_queue put_transaction element_ptr example 2 */
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue typed_put_transaction element example 1 */
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue put_transaction complete_type example 1 */
            ...
            /** If this transaction is empty the destructor has no side effects. Otherwise it cancels it.
                ...
                \snippet conc_queue_examples.cpp conc_heter_queue put_transaction destroy example 1 */
            ~put_transaction()
            {
                if (m_lock.owns_lock())
                {
        ...
        Consume functions on conc_heter_queue return a non-empty consume_operation that can be
        ...
        class consume_operation
        {
          public:
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue consume_operation default_construct example 1 */
            consume_operation() noexcept = default;

            /** Copy construction is not allowed

            \snippet conc_queue_examples.cpp conc_heter_queue consume_operation copy_construct example 1 */
            consume_operation(const consume_operation &) = delete;

            /** Copy assignment is not allowed

            \snippet conc_queue_examples.cpp conc_heter_queue consume_operation copy_assign example 1 */
            consume_operation & operator=(const consume_operation &) = delete;

            /** Move constructor. The source is left empty.

            \snippet conc_queue_examples.cpp conc_heter_queue consume_operation move_construct example 1 */
            consume_operation(consume_operation && i_source) noexcept = default;

            /** Move assignment. The source is left empty.

            \snippet conc_queue_examples.cpp conc_heter_queue consume_operation move_assign example 1 */
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue consume_operation destroy example 1 */
            ~consume_operation()
            {
                if (m_lock.owns_lock())
                    cancel();
            ...
            /** Swaps two instances of consume_operation.
                ...
                \snippet conc_queue_examples.cpp conc_heter_queue consume_operation swap example 1 */
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue consume_operation empty example 1 */
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue consume_operation operator_bool example 1 */
            explicit operator bool() const noexcept { return m_consume_operation.operator bool(); }
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue consume_operation commit_nodestroy example 1 */
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue consume_operation cancel example 1 */
            void cancel() noexcept
            {
                DENSITY_ASSERT(!empty());
            ...
            /** Returns the type of the element being consumed.
                ...
                \snippet conc_queue_examples.cpp conc_heter_queue consume_operation complete_type example 1 */
            const RUNTIME_TYPE & complete_type() const noexcept
            {
            ...
            /** Returns a pointer that, if properly aligned to the alignment of the element type, points to the element.
                ...
                \snippet conc_queue_examples.cpp conc_heter_queue consume_operation unaligned_element_ptr example 1 */
            ...
            /** Returns a pointer to the element being consumed.
                ...
                \snippet conc_queue_examples.cpp conc_heter_queue consume_operation element_ptr example 1 */
            ...
            /** Returns a reference to the element being consumed.
                ...
                \snippet conc_queue_examples.cpp conc_heter_queue consume_operation element example 1 */
            ...
            consume_operation(
              PrivateType,
              std::unique_lock<std::mutex> &&           i_lock,
              typename InnerQueue::consume_operation && i_consume_operation) noexcept
        ...
        /** Appends at the end of the queue an element of type <code>ELEMENT_TYPE</code>, copy-constructing or move-constructing
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue push example 1 */
        ...
        /** Appends at the end of the queue an element of type <code>ELEMENT_TYPE</code>, in-place-constructing it from
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue emplace example 1 */
        ...
        /** Adds at the end of the queue an element of a type known at runtime, default-constructing it.
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue dyn_push example 1 */
        ...
        /** Appends at the end of the queue an element of a type known at runtime, copy-constructing it from the source.
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue dyn_push_copy example 1 */
        ...
        /** Adds at the end of the queue an element of a type known at runtime, move-constructing it from the source.
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue dyn_push_move example 1 */
        ...
        /** Begins a transaction that appends an element of type <code>ELEMENT_TYPE</code>, copy-constructing
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue start_push example 1 */
        ...
        /** Begins a transaction that appends an element of a type <code>ELEMENT_TYPE</code>,
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue start_emplace example 1 */
        template <typename ELEMENT_TYPE, typename... CONSTRUCTION_PARAMS>
        ...
        /** Begins a transaction that appends an element of a type known at runtime, default-constructing it.
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue start_dyn_push example 1 */
        put_transaction<> start_dyn_push(const runtime_type & i_type)
        {
            std::unique_lock<std::mutex> lock(m_mutex);
            return put_transaction<>(
              PrivateType(), std::move(lock), m_queue.start_dyn_push(i_type));
        }
        ...
        /** Begins a transaction that appends an element of a type known at runtime, copy-constructing it from the source..
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue start_dyn_push_copy example 1 */
        put_transaction<> start_dyn_push_copy(const runtime_type & i_type, const void * i_source)
        {
            std::unique_lock<std::mutex> lock(m_mutex);
            return put_transaction<>(
              PrivateType(), std::move(lock), m_queue.start_dyn_push_copy(i_type, i_source));
        }
        ...
        /** Begins a transaction that appends an element of a type known at runtime, move-constructing it from the source..
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue start_dyn_push_move example 1 */
        put_transaction<> start_dyn_push_move(const runtime_type & i_type, void * i_source)
        {
            std::unique_lock<std::mutex> lock(m_mutex);
            return put_transaction<>(
              PrivateType(), std::move(lock), m_queue.start_dyn_push_move(i_type, i_source));
        }
        ...
        /** Removes and destroy the first element of the queue. This function discards the element. Use a consume function
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue pop example 1 */
        ...
        /** Removes and destroy the first element of the queue, if the queue is not empty. Otherwise it has no effect.
            ...
            \n <b>Effects on iterators</b>: any iterator pointing to the first element is invalidated
            \n <b>Throws</b>: nothing
        \snippet conc_queue_examples.cpp conc_heter_queue try_pop example 1 */
        ...
        /** Tries to start a consume operation.
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue try_start_consume example 1 */
        ...
        /** Tries to start a consume operation using an existing consume_operation object.
            ...
            For an conc_heter_queue there is no performance difference between the two overloads. Anyway
            for lock-free concurrent queue this overload may be faster.

            \snippet conc_queue_examples.cpp conc_heter_queue try_start_consume_ example 1 */
        ...
        /** Move-only class template that can be bound to a reentrant put transaction, otherwise it's empty.
            ...
            Reentrant transactional put functions on conc_heter_queue return a non-empty reentrant_put_transaction that can be
            used to allocate raw memory in the queue, inspect or alter the element while it is still not observable
            in the queue, and commit or cancel the push.
        ...
        template <typename ELEMENT_COMPLETE_TYPE = void> class reentrant_put_transaction
        {
          ...
          public:
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction copy_construct example 1 */
            reentrant_put_transaction(const reentrant_put_transaction &) = delete;

            /** Copy assignment is not allowed.

            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction copy_assign example 1 */
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction move_construct example 1

            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction move_construct example 2 */
            template <
              typename OTHERTYPE,
              typename = typename std::enable_if<
                std::is_same<OTHERTYPE, ELEMENT_COMPLETE_TYPE>::value ||
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction move_assign example 1
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction move_assign example 2 */
            template <
              typename OTHERTYPE,
              typename = typename std::enable_if<
                std::is_same<OTHERTYPE, ELEMENT_COMPLETE_TYPE>::value ||
            ...
            /** Swaps two instances of reentrant_put_transaction.
                ...
                \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction swap example 1 */
            friend void swap(
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction raw_allocate example 1*/
            void * raw_allocate(size_t i_size, size_t i_alignment)
            {
                DENSITY_ASSERT(!empty());
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction raw_allocate_copy example 1*/
            template <typename INPUT_ITERATOR>
            typename std::iterator_traits<INPUT_ITERATOR>::value_type *
              raw_allocate_copy(INPUT_ITERATOR i_begin, INPUT_ITERATOR i_end)
            {
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction raw_allocate_copy example 2 */
            template <typename INPUT_RANGE>
            auto raw_allocate_copy(const INPUT_RANGE & i_source_range)
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction cancel example 1 */
            void cancel() noexcept
            {
                DENSITY_ASSERT(!empty());
                std::lock_guard<std::mutex> lock(m_queue->m_mutex);
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction empty example 1 */
            bool empty() const noexcept { return m_queue == nullptr; }

            /** Returns true whether this object is bound to a transaction. Same to !consume_operation::empty.

            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction operator_bool example 1 */
            ...
            /** Returns a pointer to the target queue if a transaction is bound, otherwise returns nullptr
                ...
                \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction queue example 1 */
            conc_heter_queue * queue() const noexcept { return m_queue; }
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction element_ptr example 1

            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction element_ptr example 2 */
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction complete_type example 1 */
            const RUNTIME_TYPE & complete_type() const noexcept
            {
                return m_put_transaction.complete_type();
            }
            ...
            /** If this transaction is empty the destructor has no side effects. Otherwise it cancels it.
                ...
                \snippet conc_queue_examples.cpp conc_heter_queue reentrant_put_transaction destroy example 1 */
            ~reentrant_put_transaction()
            {
                if (m_put_transaction)
                {
            ...
            reentrant_put_transaction(
              PrivateType,
              conc_heter_queue * i_queue,
              typename InnerQueue::template reentrant_put_transaction<ELEMENT_COMPLETE_TYPE> &&
                i_put_transaction) noexcept
          ...
          private:
            conc_heter_queue * m_queue = nullptr;
            typename InnerQueue::template reentrant_put_transaction<ELEMENT_COMPLETE_TYPE>
              m_put_transaction;
        ...
        Reentrant consume functions on conc_heter_queue return a non-empty reentrant_consume_operation that can be
            used to inspect or alter the element while it is not observable in the queue, and
            commit or cancel the consume.
        ...
        class reentrant_consume_operation
        {
          public:
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_consume_operation default_construct example 1 */
            reentrant_consume_operation() noexcept = default;

            /** Copy construction is not allowed

            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_consume_operation copy_construct example 1 */
            reentrant_consume_operation(const reentrant_consume_operation &) = delete;

            /** Copy assignment is not allowed

            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_consume_operation copy_assign example 1 */
            reentrant_consume_operation & operator=(const reentrant_consume_operation &) = delete;

            /** Move constructor. The source is left empty.

            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_consume_operation move_construct example 1 */
            reentrant_consume_operation(reentrant_consume_operation && i_source) noexcept = default;

            /** Move assignment. The source is left empty.

            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_consume_operation move_assign example 1 */
            reentrant_consume_operation &
              operator=(reentrant_consume_operation && i_source) noexcept = default;

            /** Destructor: cancel the operation (if any).

            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_consume_operation destroy example 1 */
            ~reentrant_consume_operation()
            {
                if (!empty())
                {
            ...
            /** Swaps two instances of reentrant_consume_operation.
                ...
                \snippet conc_queue_examples.cpp conc_heter_queue reentrant_consume_operation swap example 1 */
            friend void swap(
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_consume_operation empty example 1 */
            bool empty() const noexcept { return m_consume_operation.empty(); }

            /** Returns true whether this object does not hold the state of an operation. Same to !reentrant_consume_operation::empty.

            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_consume_operation operator_bool example 1 */
            explicit operator bool() const noexcept { return m_consume_operation.operator bool(); }

            /** Returns a pointer to the target queue if a transaction is bound, otherwise returns nullptr

                \snippet conc_queue_examples.cpp conc_heter_queue reentrant_consume_operation queue example 1 */
            conc_heter_queue * queue() const noexcept { return m_queue; }
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_consume_operation commit_nodestroy example 1 */
            void commit_nodestroy() noexcept
            {
                DENSITY_ASSERT(!empty());
                std::lock_guard<std::mutex> lock(m_queue->m_mutex);
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_consume_operation cancel example 1 */
            void cancel() noexcept
            {
                DENSITY_ASSERT(!empty());
                std::lock_guard<std::mutex> lock(m_queue->m_mutex);
            ...
            /** Returns the type of the element being consumed.
                ...
                \snippet conc_queue_examples.cpp conc_heter_queue reentrant_consume_operation complete_type example 1 */
            const RUNTIME_TYPE & complete_type() const noexcept
            {
                return m_consume_operation.complete_type();
            }
            ...
            /** Returns a pointer that, if properly aligned to the alignment of the element type, points to the element.
                ...
                \snippet conc_queue_examples.cpp conc_heter_queue reentrant_consume_operation unaligned_element_ptr example 1 */
            void * unaligned_element_ptr() const noexcept
            {
                return m_consume_operation.unaligned_element_ptr();
            }
            ...
            /** Returns a pointer to the element being consumed.
                ...
                \snippet conc_queue_examples.cpp conc_heter_queue reentrant_consume_operation element_ptr example 1 */
            void * element_ptr() const noexcept { return m_consume_operation.element_ptr(); }
            ...
            /** Returns a reference to the element being consumed.
                ...
                \snippet conc_queue_examples.cpp conc_heter_queue reentrant_consume_operation element example 1 */
            template <typename COMPLETE_ELEMENT_TYPE>
            COMPLETE_ELEMENT_TYPE & element() const noexcept
            {
                return m_consume_operation.template element<COMPLETE_ELEMENT_TYPE>();
        ...
        /** Same to conc_heter_queue::push, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_push example 1 */
        ...
        /** Same to conc_heter_queue::emplace, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_emplace example 1 */
        template <typename ELEMENT_TYPE, typename... CONSTRUCTION_PARAMS>
        void reentrant_emplace(CONSTRUCTION_PARAMS &&... i_construction_params)
        {
            start_reentrant_emplace<typename std::decay<ELEMENT_TYPE>::type>(
              std::forward<CONSTRUCTION_PARAMS>(i_construction_params)...)
              .commit();
        }
        ...
        /** Same to conc_heter_queue::dyn_push, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_dyn_push example 1 */
        ...
        /** Same to conc_heter_queue::dyn_push_copy, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_dyn_push_copy example 1 */
        ...
        /** Same to conc_heter_queue::dyn_push_move, but allows reentrancy: during the construction of the element the queue is in a
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_dyn_push_move example 1 */
        ...
        /** Same to conc_heter_queue::start_push, but allows reentrancy: during the construction of the element, and until the state of
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue start_reentrant_push example 1 */
        template <typename ELEMENT_TYPE>
        ...
        /** Same to conc_heter_queue::start_emplace, but allows reentrancy: during the construction of the element, and until the state of
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue start_reentrant_emplace example 1 */
        template <typename ELEMENT_TYPE, typename... CONSTRUCTION_PARAMS>
        ...
        /** Same to conc_heter_queue::start_dyn_push, but allows reentrancy: during the construction of the element, and until the state of
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue start_reentrant_dyn_push example 1 */
        ...
        /** Same to conc_heter_queue::start_dyn_push_copy, but allows reentrancy: during the construction of the element, and until the state of
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue start_reentrant_dyn_push_copy example 1 */
        reentrant_put_transaction<>
        ...
        /** Same to conc_heter_queue::start_dyn_push_move, but allows reentrancy: during the construction of the element, and until the state of
            ...
            <b>Examples</b>
            \snippet conc_queue_examples.cpp conc_heter_queue start_reentrant_dyn_push_move example 1 */
        reentrant_put_transaction<>
        ...
        /** Removes and destroy the first element of the queue. This is the reentrant version of pop.
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue reentrant_pop example 1 */
        ...
        /** Removes and destroy the first element of the queue, if the queue is not empty. Otherwise it has no effect.
            ...
            \n <b>Effects on iterators</b>: any iterator pointing to the first element is invalidated
            \n <b>Throws</b>: nothing
        \snippet conc_queue_examples.cpp conc_heter_queue try_reentrant_pop example 1 */
        ...
        /** Tries to start a reentrant consume operation.
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue try_start_reentrant_consume example 1 */
        ...
        /** Tries to start a consume operation using an existing consume_operation object.
            ...
            \snippet conc_queue_examples.cpp conc_heter_queue try_start_reentrant_consume_ example 1 */
